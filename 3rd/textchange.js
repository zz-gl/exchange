(function(b){
    b.event.special.textchange={
        setup:function(d,a){
            ...
            b(this).bind("compositionstart.textchange",b.event.special.textchange.imeStartHandler);
            b(this).bind("compositionend.textchange",b.event.special.textchange.imeEndHandler);
